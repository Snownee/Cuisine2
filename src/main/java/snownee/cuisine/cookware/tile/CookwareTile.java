...
public class CookwareTile<C extends CookwareTile<C>> extends AbstractCookwareTile implements INamedContainerProvider {
    ...
    private final LazyOptional<ItemStackHandler> inputProvider;
    ...
    public CookwareTile(Cookware cookware) {
        ...
        inputProvider = LazyOptional.of(() -> inputHandler);
        unsidedProvider = LazyOptional.of(() -> new CombinedInvWrapper(inputHandler, outputHandler.get()) {
            @Override
            public boolean isItemValid(int slot, ItemStack stack) {
