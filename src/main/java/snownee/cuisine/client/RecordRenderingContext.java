...
public class RecordRenderingContext {
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, ItemStack stack) {
        ...
        mc.getItemRenderer().renderItem(null, new ItemStack(Items.MUSHROOM_STEW), TransformType.GUI, false, matrixStackIn, bufferIn, mc.world, combinedLightIn, OverlayTexture.NO_OVERLAY);
        matrixStackIn.translate(0, -1, 0);
        mc.getItemRenderer().renderItem(null, new ItemStack(Items.RED_MUSHROOM), TransformType.GUI, false, matrixStackIn, bufferIn, mc.world, combinedLightIn, OverlayTexture.NO_OVERLAY);
        matrixStackIn.translate(0, -1, 0);
        mc.getItemRenderer().renderItem(null, new ItemStack(Items.BROWN_MUSHROOM), TransformType.GUI, false, matrixStackIn, bufferIn, mc.world, combinedLightIn, OverlayTexture.NO_OVERLAY);
